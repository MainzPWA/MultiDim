...
function (ROOT_GENERATE_DICTIONARY HEADERS LINKDEF_FILE DICTFILE INCLUDE_DIRS)
  ...
  add_custom_command(OUTPUT ${DICTFILES}
    ...
    ROOTSYS=${ROOTSYS}
    ${RLIBMAP_EXECUTABLE}
    -o "${CMAKE_BINARY_DIR}/lib${PROJ}.so.rootmap" -l "${CMAKE_BINARY_DIR}/lib${PROJ}.so" -d "${DEPLIBS}" -c "${LINKDEF_FILE}"
    DEPENDS ${HEADERS} ${LINKDEF_FILE}
    COMMENT "Creating ROOT dictionary and .rootmap file..."
    )
  ...
  configure_file("${LINKDEF_FILE}" "${STAMP_FILE}" COPY_ONLY)
